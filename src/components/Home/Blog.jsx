  ...
  return (
    <section>
      <div className="containers">
        ...
        {blogs.length === 0 && (
          <div className="bg-[#161616]/20 rounded-2xl p-6 overflow-hidden border border-gray-700 hover:border-gray-600 transition-all duration-300 hover:transform hover:scale-105">
            <p className="text-center header-text w-full">No blogs found</p>
          </div>
        )}
